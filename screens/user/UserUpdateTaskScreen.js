...
export default function UserUpdateTaskScreen(props) {
  ...
  return(
    <View style={styles.container}>
      ...
      <Row title="Content " data={content}/>
      <Row title="Assigned to " data={assignedTo}/>
      <Row title="Start date " data={startDate}/>
      <Row title="Start time " data={startTime}/>
      <Row title="End date " data={endDate}/>
      <Row title="End time " data={endTime}/>
      <>
      ...
      <Row title="Manager comment " data={comment}/>
      <Row title="Manager evaluation" data={evaluation}/>
      <Row title="Finish confirmation" data={confirmation}/>
