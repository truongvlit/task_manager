  ...
  return(
    <View>
      <View style={styles.form}>
        <Row title="Source from: " value={sourceFrom} placeholder="Enter username" onChange={setSourceFrom}/>
        <Row title="Task content: " value={content} placeholder="Enter password" onChange={setContent}/>
        ...
        <Row title="Assigned to: " value={assignedTo} placeholder="Enter email" onChange={setAssignedTo}/>
      </View>
